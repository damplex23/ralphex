#!/usr/bin/env bash
# copilot-as-gemini_docs_test.sh — validates Copilot wrapper documentation snippets.
...
echo "running copilot-as-gemini docs tests"
echo ""

assert_executable "$REPO_ROOT/scripts/copilot-as-gemini/copilot-as-gemini.sh" "wrapper script is executable"
assert_executable "$REPO_ROOT/scripts/copilot-as-gemini/copilot-as-gemini_test.sh" "wrapper shell test is executable"

assert_contains \
    "$REPO_ROOT/scripts/copilot-as-gemini/README.md" \
