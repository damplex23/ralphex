#!/usr/bin/env bash
# opencode-as-gemini_test.sh — tests for opencode-as-gemini.sh wrapper.
#
...
WRAPPER="$SCRIPT_DIR/opencode-as-gemini.sh"
...
echo "running opencode-as-gemini.sh tests"
echo ""
...
API Error: invalid api key for model gemini/gemini-3
EOF
