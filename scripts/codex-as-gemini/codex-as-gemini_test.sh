#!/usr/bin/env bash
# codex-as-gemini_test.sh — tests for codex-as-gemini.sh wrapper.
#
# run from the ralphex directory:
#   bash scripts/codex-as-gemini/codex-as-gemini_test.sh
#
# requires: jq, bash
...
WRAPPER="$SCRIPT_DIR/codex-as-gemini.sh"
...
echo "running codex-as-gemini.sh tests"
echo ""
